  ...
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td width="98%"><b>Organization number: <?php echo variable_get('uc_store_vat_number', t('Your store VAT number.')) ?></b></td>
        </tr>
        <?php } ?>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td valign="top">
                        <?php if ($order->vat_number): ?>
                        <b>Your VAT number:</b> <?php echo $order->vat_number ?>
                        <?php endif; ?>
                      </td>
                    </tr>
                  </table>
